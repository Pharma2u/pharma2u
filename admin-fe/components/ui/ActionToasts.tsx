...
function actionCopy(url: string, method: string) {
  ...
  if (path.includes("/approve"))
    return ["Approving…", "Approved successfully."];
  if (path.includes("/reject"))
    return ["Rejecting…", "Rejected successfully."];
  if (path.includes("/image") || path.includes("/logo"))
    return ["Uploading image…", "Image uploaded successfully."];
