...
} from "../controllers/pharmacy-employee.controller";
...
import {
  ...
  listHomepageBanners,
  listPublicHomepageBanners,
  updateHomepageBanner,
  uploadHomepageBannerImage,
} from "../controllers/homepage-banner.controller";

const router = Router();
const pharmacyImageUpload = multer({
...
router.post(
  "/admin/homepage-banners/image",
  ...admin,
  pharmacyImageUpload.single("image"),
  uploadHomepageBannerImage,
);
...
router.get("/vendor/pharmacy/employees", ...vendor, listPharmacyEmployees);
router.post("/vendor/pharmacy/employees", ...vendor, createPharmacyEmployee);
router.patch(
  "/vendor/pharmacy/employees/:id",
  ...vendor,
  updatePharmacyEmployee,
);
router.get("/vendor/pharmacy/me", ...vendor, myPharmacy);
router.patch(
  "/vendor/pharmacy/me/profile",
  ...vendor,
  pharmacyImageUpload.fields([
